...
# the declaration of a new mutation
  mutation loginUser($email: String!, $password: String!) {
    # Now calling the back-end mutation loginUser on the server and passing the variables
    # loginUser is whats returned to the front end
    loginUser(email: $email, password: $password) {
      # asking for the token feild from the returned Auth Object as defined in the typeDefs
      token
      # asking for the nested user field within the Auth object.
      user {
        _id
        username
        email
